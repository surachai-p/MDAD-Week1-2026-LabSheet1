...
<img width="1222" height="887" alt="image" src="https://github.com/user-attachments/assets/36487bbb-1cb7-4c61-b887-8da9f4437082" />
```
...
<img width="1918" height="1078" alt="Screenshot 2026-07-10 003653" src="https://github.com/user-attachments/assets/a426b056-ac32-46ec-81af-1ef78f6d0f0d" />

**Widget Tree ที่วาด:**

<img width="1546" height="863" alt="Screenshot 2026-07-10 000519" src="https://github.com/user-attachments/assets/7d5251ec-ddab-437e-8853-f03a33a39240" />
...
| ใช้เมื่อไหร่ |แก้ไข UI, ข้อความ, สี, Widget |แก้ไขโครงสร้างโปรแกรม |
...
```
คำตอบ: Flutter ใช้ Rendering Engine ของตัวเอง ในการวาด UI ส่วน React Native ใช้ Native Components ของแต่ละระบบปฏิบัติการในการแสดงผล
```

**2.** อธิบายความแตกต่างระหว่าง `StatelessWidget` และ `StatefulWidget` พร้อมยกตัวอย่างการใช้งานที่เหมาะสมของแต่ละประเภท

```
คำตอบ: 1. StatelessWidget: ข้อมูลไม่เปลี่ยนแปลงหลังสร้าง เหมาะกับข้อความหรือไอคอน เช่น Text, Icon 
2. StatefulWidget: ข้อมูลสามารถเปลี่ยนแปลงได้ระหว่างใช้งาน เหมาะกับปุ่มนับจำนวน การรับข้อมูลจากผู้ใช้ หรือฟอร์ม
```

**3.** เหตุใดจึงห้าม Commit API Key ลง Git Repository? และมีวิธีจัดการ API Key อย่างปลอดภัยอย่างไรบ้าง?

```
คำตอบ: เพราะ API Key อาจถูกผู้อื่นนำไปใช้ ทำให้ข้อมูลรั่วไหลหรือมีค่าใช้จ่ายเพิ่ม ควรเก็บไว้ในไฟล์ที่ไม่ถูก Commit เช่น .env หรือไฟล์ Config ที่เพิ่มใน .gitignore
```

**4.** Hot Reload ทำงานอย่างไร และมีข้อจำกัดอะไรบ้าง?

```
คำตอบ: Hot Reload จะอัปเดตโค้ดที่แก้ไขโดยไม่รีสตาร์ตแอป ทำให้เห็นผลเร็วและ State ยังอยู่ แต่ไม่สามารถอัปเดตการเปลี่ยนแปลงบางอย่าง เช่น main() หรือการกำหนดค่าเริ่มต้นบางประเภท ต้องใช้ Hot Restart แทน
```
...
```
คำตอบ: 
1. สร้างระบบแชตบอตตอบคำถามผู้ใช้ภายในแอป
2. สรุปหรืออธิบายข้อความและเอกสารอัตโนมัติ
3. ช่วยสร้างเนื้อหา เช่น เขียนอีเมล
```
